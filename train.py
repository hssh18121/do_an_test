...
from models import SegFormer_B5
...
checkpoint_path = "./weights/augmented_segformer_B5/cp.weights.h5"
...
model = SegFormer_B5(input_shape=(256, 256, 3), num_classes=5)
...
plt.legend()
plt.show()
plt.savefig('./result/augmented_segformer_B5/loss.png')
...
plt.legend()
plt.show()
plt.savefig('./result/augmented_segformer_B5/mean_iou.png')